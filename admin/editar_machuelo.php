...
<br>	
<font size="5">&nbsp;&nbsp;Editar Machuelo</font>
	</head>

	<body>
	<form id='texttests' name='myform' action='?dir=productos&accion=guardaredicion_machuelo&clave=<?php echo $_GET["clave"];?>' method='post'>;
			...
			<center>
				<div class="derecha">					
					...
					<div align ="center">
						...
						<button text style="font-weight:bold;" type="button" class="btn btn-danger" onclick="window.location='?dir=productos&accion=mostrar_machuelos'">Cancelar</button>&nbsp;
						<br>
					</div><br>
				</div>
			</center>
