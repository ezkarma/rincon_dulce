<script type="text/javascript">
		function eliminar(idalu)
		{
				...
				if (r==true)
				{
					x= window.location.href = "?dir=productos&accion=eliminar_broca&clave="+idalu;		
				}
...
$productos = Producto::cargar_broca();
...
echo "<tr>";
	...
	?>
	<td><button type="button" class="btn btn-success" onclick="window.location='?dir=productos&accion=editar_broca&clave=<?php echo $broca->clave; ?>'">Editar</button></td>
