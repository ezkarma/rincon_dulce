<script type="text/javascript">
		function eliminar(idalu)
		{
				...
				if (r==true)
				{
					x= window.location.href = "?dir=productos&accion=eliminar_endmill&clave="+idalu;		
				}
...
$productos = Producto::cargar_endmill();

echo "<font size='5'>";
echo "<br>Endmills&nbsp&nbsp&nbsp&nbsp&nbsp</b>";
echo "</font>";
...
echo "<tr>";
	...
	?>
	<td><button type="button" class="btn btn-success" onclick="window.location='?dir=productos&accion=editar_endmill&clave=<?php echo $broca->clave; ?>'">Editar</button></td>
