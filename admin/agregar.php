...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="box">
		<div class="box2" >
			<blockquote><font color="orange" size="4px" >Agregar Usuario</font></blockquote><br>	
		</div>
		
		<div class="box1">			
			<form name="login" action="/?dir=guardar&controller=admin"  method="post">
				...
				<div class="box3">
				<button text style="font-weight:bold;" title="Guardar" name="guardar" class="btn btn-success" type="submit" value="Guardar"/>Guardar</button>&nbsp;&nbsp;&nbsp;&nbsp;
