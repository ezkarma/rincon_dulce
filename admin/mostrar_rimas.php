<script type="text/javascript">
		function eliminar(idalu)
		{
				...
				if (r==true)
				{
					x= window.location.href = "?dir=productos&accion=eliminar_rima&clave="+idalu;		
				}
...
$productos = Producto::cargar_rima();

echo "<font size='5'>";
echo "<br>Rimas&nbsp&nbsp&nbsp&nbsp&nbsp</b>";
echo "</font>";
...
echo "<tr>
		...
		<th width='100'><font size='2'>Categoria</font></th>
		...
		<th width='70'><center><font size='2'>Exitencia</font></center></th>
...
echo "<tr>";
	...
	?>
	<td><button type="button" class="btn btn-success" onclick="window.location='?dir=productos&accion=editar_rima&clave=<?php echo $broca->clave; ?>'">Editar</button></td>
